...
def main(refer_img_path, target_img_path):
    ...
    # image 경로
    style_reference_image_path = 'D:/develop/Flask/flaskProject/static/images/nst_get/' + refer_img_path  # 스타일 참조 이미지
    target_image_path = 'D:/develop/Flask/flaskProject/static/images/' + target_img_path  # 타깃 이미지
    ...
    result_prefix = 'D:/develop/Flask/flaskProject/static/images/nst_result_' + refer_img_name
    iterations = 3
